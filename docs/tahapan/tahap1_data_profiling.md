...
5. **Duplicate analysis**:
   ...
   - Duplicate by `NIB` (harusnya unik per sistem)
...
7. **Baseline Data Quality Score**: hitung Completeness, Validity, Uniqueness untuk OSS dan CEISA (skor "before" — jadi pembanding di Tahap 2 & 5)
...
| 17-18 | Data Quality Scorecard & Visualisasi | Pola dipakai sebagai baseline |
